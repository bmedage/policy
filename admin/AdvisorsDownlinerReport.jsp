...
<html>
<head>
<title>Advisors Downline Report</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Advisor Report<i class="fa fa-angle-right"></i>Advisor Down line Report</li>
             
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1" style = "height:300px;">
  	      <center> <h3>Advisors Downline Report<button id='btnExport' style="float: right; margin-bottom: 10px;"
								class="btn btn-primary forprint"  onclick="download();">
								<i class="fa  fa-file-excel-o"></i>
							</button>
							<button style="float: right; margin-bottom: 10px;"
								class="btn btn-success forprint" onclick="printDiv('Advname')">
    ...
    <script type="text/javascript" src="http://sheetjs.com/demos/Export2Excel.js"></script>
  	  ...
  	  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action = "AdvisorsDownlinerReport.jsp" method = "post">
								
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Fin Year</label>
									<div class="col-sm-8">
										<select class="form-control1" id="year" name="year" placeholder="" onchange="showState(this.value)">
										<option>--Select--</option>
										<%
										Connection con2=DBConnection.getConnection();
										PreparedStatement ptmt=con2.prepareStatement("set global max_connections=100000000");
										ptmt.executeQuery();
										PreparedStatement pst2=con2.prepareStatement("select * from advisordownlinereport group by year");
										ResultSet r2=pst2.executeQuery();
										while(r2.next())
										{%>
										<option value="<%=r2.getString("year")%>"><%=r2.getString("year") %></option>
										<%} %>
										</select>
										<script type="text/javascript">
										 var xmlHttp  
									      ...
									      var url="AdvisorsDownlinerReportAddAdvName.jsp";
									      url +="?year=" +str;
									      ...
									      var url="AdvisorsDownlinerReportAddAdvCode.jsp";
									      url +="?year=" +str;
										...
										function callByOPCYear()
										{
											var xmlhttp;
											var year=document.getElementById("year").value;
											
											var urls="AdvDownByYear.jsp?year="+year;
											...
											xmlhttp.onreadystatechange=function(){
											  if (xmlhttp.readyState==4){
											        ...
											        document.getElementById("Advname").innerHTML = result;
											    }
											};
								...
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">ADV Name</label>
									<div class="col-sm-8" id="state">
										<select class="form-control1" id="name" name="name" placeholder="" onchange="callByOPCName()">
										<option>--Select--</option>
										<%-- <%
										Connection con1=DBConnection.getConnection();
										PreparedStatement pst=con1.prepareStatement("select * from advisordownlinereport group by name");
										...
										<script type="text/javascript">
										function callByOPCName()
										{
											var xmlhttp;
											var AdvName=document.getElementById("name").value;
											var year=document.getElementById("year").value;
											
											var urls="AdvDownByName.jsp?AdvName="+AdvName+"&year="+year;
											if (window.XMLHttpRequest){
											  xmlhttp=new XMLHttpRequest();
											  }
											else{
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Adv ID</label>
									<div class="col-sm-8" id="state1">
										<select class="form-control1" name="advCode" id="advCode" placeholder="" onchange="callByAdvId()">
										<option>--Select--</option>
										<%-- <%
										PreparedStatement pst1=con1.prepareStatement("select * from advisordownlinereport group by advCode");
										ResultSet r1=pst1.executeQuery();
										while(r1.next())
										{%>
										<option value="<%=r1.getString("advCode")%>"><%=r1.getString("advCode") %></option>
										<%} %> --%>
										</select>
										<script type="text/javascript">
										function callByAdvId()
										{
											...
											var year=document.getElementById("year").value;
											urls="AdvDownById.jsp?advCode="+advCode+"&year="+year;
											if (window.XMLHttpRequest){
											  xmlhttp=new XMLHttpRequest();
											  }
											else{
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;"><!-- Date To --> </label>
									...
									function callByDate()
									{
										...
										var urls="AdvDownByDate.jsp?dateFrom="+dateFrom+"&dateTo="+dateTo;
										if (window.XMLHttpRequest){
										  xmlhttp=new XMLHttpRequest();
										  }
										else{
										...
										xmlhttp.onreadystatechange=function(){
										  if (xmlhttp.readyState==4){
										        var result=xmlhttp.responseText;
										        document.getElementById("Avdt").innerHTML = result;
										    }
										};
										xmlhttp.open("GET",urls,true);
										xmlhttp.send();
 	...
 	<font color="blue"><center><h3>Report</h3></center></font>
 <div id="Advname">
