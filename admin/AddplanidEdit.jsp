...
<!--heder end here-->
  ...
  <div class="col-md-10">
  <center><h3 style=" margin-left: 5%;"><b>Edit Plan ID</b></h3></center>
  </div>
 	...
 	String select="";
 	PreparedStatement pstmt=cn.prepareStatement("select * from addplan where planid=? And year=? And type=? group by planid");
	...
	%>		
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AdddplanidUpdate.jsp" method="post">
							<input  type="hidden" name="year" value="<%=rs.getString("year")%>">
								<div class="form-group">
								<label for="inputPassword" class="col-sm-2 control-label">Financial year </label>
									<div class="col-sm-4">
									<select    id="type" name="year" class="form-control" disabled="disabled">
									...
									<input type="hidden" value="<%=rs.getString("year")%>" id="type" name="year" class="form-control">
									<input  type="hidden" name="type" value="<%=rs.getString("type")%>">
									<label for="inputPassword" class="col-sm-1 control-label">Type</label>
									<div class="col-sm-4">
								...
								<input type="hidden" id="type" value="<%=rs.getString("type")%>" name="type" class="form-control">
									</div>
								...
								<label for="inputPassword" class="col-sm-2 control-label">Plan Id</label>
									<div class="col-sm-4">
									<input type="text" value="<%=rs.getString("planid")%>" class="form-control1" id="inputPassword" placeholder="Ex.P102" name="planid" disabled="disabled">
									
								
									
									</div>
									<label for="inputPassword" class="col-sm-1 control-label">Amount</label>
									<div class="col-sm-4">
									
									<input type="Text" value="<%=rs.getString("amount")%>" class="form-control1" id="inputPassword" placeholder="Ex.P102" name="amount">
								...
								<label for="inputPassword" class="col-sm-1 control-label"></label>
									<div class="col-sm-4">
									<button style="float: right;" class="btn-primary btn">Update Plan ID</button>
