...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Policy List</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1">
  	      <center> <h3>Policy List</h3></center>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post">
								<div class="form-group">
								<div class="col-md-5">
								<label for="inputPassword" class="col-sm-2 control-label">Fin Year</label>
									<div class="col-sm-10">
										<select class="form-control1" id="year" placeholder="DD/MM/YYYY" name="year" onChange="finyearCall()">
										<option>-select-</option>
									<%
									Connection conn1=DBConnection.getConnection();
										PreparedStatement ptmt=conn1.prepareStatement("set global max_connections=100000000");
										ptmt.executeQuery();
										PreparedStatement pstmt1=conn1.prepareStatement("select * from add_new_policy group by finyear");
									ResultSet rs1=pstmt1.executeQuery();
									while(rs1.next())
									{
									%>
									<option value="<%=rs1.getString("finyear") %>"><%=rs1.getString("finyear") %></option>
									<% }%>
								</select>
								...
								<div class="col-md-5">
								<label for="inputPassword" class="col-sm-2 control-label">Adv Name </label>
									<div class="col-sm-10">
										<select class="form-control1" id="popcnameid" placeholder="DD/MM/YYYY" name="popcname" onChange="popcnamecall()">
										<option>-select-</option>
									<%
									PreparedStatement pstmt4=conn1.prepareStatement("select * from add_new_policy group by intro_name");
									ResultSet rs4=pstmt4.executeQuery();
									while(rs4.next())
									{
									%>
									<option value="<%=rs4.getString("intro_name") %>"><%=rs4.getString("intro_name") %></option>
									<%} %>
								</select>
								...
								<div class="col-md-2">
			<button style="float: right;" class="btn-primary btn">Done</button>
			</div>
			
								</div>
								<div class="form-group">
								<div class="col-md-5">
								<label for="inputPassword" class="col-sm-2 control-label">Cust ID</label>
									<div class="col-sm-10">
										<select class="form-control1" id="pcustid" placeholder="DD/MM/YYYY" name="pcustname" onChange="pcustidcall()">
										<option>-select-</option>
									<%
									Connection conn2=DBConnection.getConnection();
									PreparedStatement pstmt2=conn1.prepareStatement("select * from add_new_policy");
									ResultSet rs2=pstmt2.executeQuery();
									while(rs2.next())
									{
									%>
									<option value="<%=rs2.getInt("Cust_id") %>"><%=rs2.getInt("cust_id") %></option>
									<% }%>
								</select>
									</div>
								</div>
								...
								<div class="col-md-5">
								<label for="inputPassword" class="col-sm-2 control-label">Adv Code  </label>
									<div class="col-sm-10">
										<select class="form-control1" id="introCode" placeholder="DD/MM/YYYY" name="introCode" onChange="introCodecall()">
										<option>-select-</option>
									<%
									PreparedStatement pstmt5=conn1.prepareStatement("select * from add_new_policy");
									ResultSet rs5=pstmt5.executeQuery();
									while(rs5.next())
									{
									%>
									<option value="<%=rs5.getInt("introCode") %>"><%=rs5.getInt("introCode") %></option>
									<% }%>
								</select>
									</div>
								</div> 
								<!-- <div class="col-md-5">
								<label for="inputPassword" class="col-sm-2 control-label">Date From  </label>
									<div class="col-sm-10">
										<input type="date" class="form-control1" id="datefromid" name="datefromname">
									</div>
								</div> -->
									
									<!-- <div class="col-md-5">
								<label for="inputPassword" class="col-sm-2 control-label">Date To </label>
									<div class="col-sm-10">
										<input type="date" class="form-control1" id="datetoid"   name="datetoname" onChange="pdatechangecall()">
									</div>
								</div> -->
								</div>
...
<!-- ONCHANGE EVENT -->
<script>
function finyearCall()
{
	var xmlhttp;
	var year=document.getElementById("year").value;
	var urls="policyYear.jsp?year="+year;
...
function introCodecall()
{
	var xmlhttp;
	var popcname=document.getElementById("popcnameid").value;
	var year=document.getElementById("year").value;
	var introCode=document.getElementById("introCode").value;
	var urls="policyAdvCode.jsp?introCode="+introCode+"&popcname="+popcname+"&year="+year;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
...
function popcnamecall()
{
	var xmlhttp;
	var year=document.getElementById("year").value;
	var popcname=document.getElementById("popcnameid").value;
	var urls="policyOPCName.jsp?popcname="+popcname+"&year="+year;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
...
function pcustidcall()
{
	var xmlhttp;
	var popcname=document.getElementById("popcnameid").value;
	var year=document.getElementById("year").value;
	var ppcustid=document.getElementById("pcustid").value;
	var urls="PolicyCustID.jsp?ppcustid="+ppcustid+"&popcname="+popcname+"&year="+year;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
...
function pdatechangecall()
{
	var xmlhttp;
	var pdatefrom=document.getElementById("datefromid").value;
	var pdateto=document.getElementById("datetoid").value;
	
	alert("Date From To to "+pdatefrom +" "+pdateto);
	var urls="PolicyFromToDate.jsp?pdateto="+pdateto+"&pdatefrom="+pdatefrom;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-gear" aria-hidden="true"></i><span> Set Up</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="#">Edit Admin Detail</a></li>
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>PIN Master</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="UseandUnusePinSummary.jsp">Use/unused PIN</a></li>
											<li id="menu-academico-avaliacoes" ><a href="opcpinrequest.jsp">Allot Requested Pin</a></li>
											</ul>
										</li>
										...
										<li id="menu-academico"><a href="paymentmaster.jsp"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Change Master</span><span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
												<ul id="menu-academico-sub" >
										...
										<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Advisor Maturity Section Form</span><div class="clearfix"></div></a></li>
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Advisor Report</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="AdvisorTeamPolicyList.jsp">Advisor Team Policy List</a></li>
											...
											<ul id="menu-academico-sub" >
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">Advisor Paid MIS List</a></li>
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">Advisor Pending MIS List</a></li>
											</ul>
											</li>
											...
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">Advisor  Maturity Report(Paid/Pending)</a></li>
											</ul>
											</li>
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Yearly Advisor Reports</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="OPCTeamPolicyList.jsp">OPC Team Policy List</a></li>
											...
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">OPC Maturity Report(Paid/Pending)</a></li>
											</ul>
											</li>
											
											<li id="menu-academico-avaliacoes" ><a href="Maturity Section List.jsp">OPC MIS List</a>
											<ul id="menu-academico-sub" >
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">OPC  Paid MIS List</a></li>
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">OPC  Pending MIS List</a></li>
											</ul>
											</li>
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Coampany Report</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
											...
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">Company Maturity Report(Paid/Pending)</a></li>
											</ul>
											</li>
											
											<li id="menu-academico-avaliacoes" ><a href="Maturity Section List.jsp">Company MIS List</a>
											<ul id="menu-academico-sub" >
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">Company Paid MIS List</a></li>
											<li style="background-color: #333333;width: 300px;" id="menu-academico-avaliacoes" ><a href="#">Company Pending MIS List</a></li>
											</ul>
											</li>
