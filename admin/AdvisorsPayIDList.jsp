...
<html>
<head>
<title>Company Pay-ID List</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
	 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Company Report<i class="fa fa-angle-right"></i>Company Pay-ID List</li>
  ...
  <div class="grid-form1">
  	      <center> <h3>Company Pay-ID List<button id='btnExport' style="float: right; margin-bottom: 10px;"
								class="btn btn-primary forprint"  onclick="download();">
								<i class="fa  fa-file-excel-o"></i>
							</button>
							<button style="float: right; margin-bottom: 10px;"
								class="btn btn-success forprint" onclick="printDiv('AdvId')">
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post">
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Fin Year</label>
									<div class="col-sm-8">
										<select class="form-control1" name="year" id="year" placeholder="" onchange="showState(this.value)">
										<option>Select</option>
										<%
										Connection con=DBConnection.getConnection();
										PreparedStatement ptmt=con.prepareStatement("set global max_connections=100000000");
										ptmt.executeQuery();
										PreparedStatement ps=con.prepareStatement("select * from transaction group by year");
										...
										<script type="text/javascript">
										 ...
										 var xmlHttp  
									      ...
									      var url="AdvisorsPayIDListAddAvId.jsp";
									      url +="?year=" +str;
										...
										function callByYear()
										{
											...
											var urls="AdvisorPayByYear.jsp?year="+year;
											...
											xmlhttp.onreadystatechange=function(){
											  if (xmlhttp.readyState==4){
											        ...
											        document.getElementById("AdvId").innerHTML = result;
											    }
											};
								...
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Adv ID</label>
									<div class="col-sm-8" id="state">
										<select class="form-control1">
										<option>--Select--</option>
										 <%-- <%
										Connection con1=DBConnection.getConnection();
										PreparedStatement pst1=con1.prepareStatement("select * from transaction group by pinNo");
										ResultSet r1=pst1.executeQuery();
										while(r1.next())
										{%>
										<option value="<%=r1.getString("pinNo")%>"><%=r1.getString("pinNo") %></option>
										<%} %>  --%>
										</select>
										<script type="text/javascript">
										function callByAdvId()
										{
											var xmlhttp;
											var year=document.getElementById("year").value;
											var pinNo=document.getElementById("pinNo").value;
											var urls="AdvisorPaidById.jsp?pinNo="+pinNo+"&year="+year;
											if (window.XMLHttpRequest){
											  xmlhttp=new XMLHttpRequest();
											  }
											else{
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Date From  </label>
									<div class="col-sm-8">
										<input type="date" class="form-control1"  placeholder="" name="dateFrom" id="dateFrom">
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Date To </label>
									<div class="col-sm-8">
										<input type="date" class="form-control1"  placeholder=""  name="dateTo" id="dateTo" onchange="callByDate()">
									</div>
									<script type="text/javascript">
									function callByDate()
									{
										...
										var year=document.getElementById("year").value;
										var pinNo=document.getElementById("pinNo").value;
										var urls="AdvisorPayByDate.jsp?dateFrom="+dateFrom+"&dateTo="+dateTo+"&year="+year+"&pinNo="+pinNo;
										if (window.XMLHttpRequest){
										  xmlhttp=new XMLHttpRequest();
										  }
										else{
