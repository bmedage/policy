...
System.out.println("Opc Name = "+opcName);
 ...
 String buffer="<select class='form-control1' id='advcodeid' placeholder='DD/MM/YYYY' name='advcodeid' onChange='advcodecall()'><option value='-1'>- - Select - -</option>";  
 try{
	 Connection con1=DBConnection.getConnection();
	 PreparedStatement ptmt=con1.prepareStatement("set global max_connections=100000000");
	 ptmt.executeQuery();
	 PreparedStatement pstmt=con1.prepareStatement("select * from advisors where year=? group by pin_no");
