...
<html>
<head>
<title>Advisor Team Promotive Incentive</title>
...
<li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Yearly Advisor Report <i class="fa fa-angle-right"></i>Advisor Promotive Incentive List</li>
                </i></li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1" style = "height:320px;">
  	      <center> <h3>Advisor Promotive Incentive List<button id='btnExport' style="float: right; margin-bottom: 10px;"
...
var url="AdvisorsTeamPromIncenListAddAdvCode.jsp";
url +="?year=" +str;
...
function dispTbByOpcName()
{
	...
	alert(year);
	alert(opcName);
	var urls="AdvisorsTeamPromIncenListDispTbByOpcName.jsp?year="+year+"&opcName="+opcName;
...
function dispTbByAdvCode()
{
	...
	var urls="AdvisorsTeamPromIncenListDispTbByAdvNm.jsp?year="+year+"&advCode="+advCode;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
