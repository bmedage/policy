...
<html>
<head>
<title>Add Edit New Advisor</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Add Edit</a><i class="fa fa-angle-right"></i>Add Edit New Advisors</li>
  ...
  <div class="grid-form1">
  	      <center> <h3>Add Edit New Advisors</h3></center>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="addnewadvicerSave.jsp" method="post">
								<%
								Connection con=DBConnection.getConnection();
								Statement stmt = con.createStatement();
								String query = "SELECT * FROM opc_avai_pin";
								...
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Pin No</label>
									<div class="col-sm-8">
									<input type="hidden" name="pinNos" value="<%=count%>" id="pinno1">
										<input type="text" value="<%=count%>" name="pinno" id="pinno" class="form-control" placeholder="1000 1000 1000 5156" disabled="disabled" required>
									</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">IntroLevel</label>
									<div class="col-sm-8">
									<select class="form-control1" id="introlevel" name="introlevel" placeholder="DD/MM/YYYY" name="level" onchange="getAllotLevel(this.value)" required>
									<option>-select-</option>
									<%
									Connection conn1=DBConnection.getConnection();
									PreparedStatement pstmt1=conn1.prepareStatement("select * from level");
									ResultSet rs1=pstmt1.executeQuery();
									while(rs1.next())
									{
									%>
									<option value="<%=rs1.getString("level") %>"><%=rs1.getString("level") %></option>
									<% }%>
								</select>
								<script type="text/javascript">
								 ...
								 var xmlHttp  
							      ...
							      document.getElementById("addAllotLevel").innerHTML=xmlHttp.responseText   
							      }   
							      }
									...
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Allot Level</label>
									<div class="col-sm-8" id="addAllotLevel">
									<select class="form-control" name="allotlevel" id="allotlevel">
									<option>--Select--</option>
									</select>
									</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Intoducer Code</label>
									<div class="col-sm-8">
										<input type="text" name="intCode" id="introCode" class="form-control1" id="inputPassword" placeholder="" onchange="s()"required>
									...
									function s()
									{
										 	...
										 	var urls="getIntroNameForadvisor.jsp?introId="+introCode;  
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Intro name</label>
									<div class="col-sm-8">
										<input type="text" name="itroName" class="form-control" id="introName" placeholder="" required disabled="disabled">
										<input type="hidden" name="itroName" class="form-control1" id="introName" placeholder="" required>
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Mobile Number</label>
									<div class="col-sm-8">
									<input type="text" maxlength="10"  name="mobNo" class="form-control1" id="mobNo" onkeyup="numbersonly()">
						...
						function numbersonly()
							{
								...
								{
								alert("Please enter only digit in mobile number");
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Near OPC</label>
									...
									PreparedStatement pstmt2=cn.prepareStatement("select * from opc_master");
									ResultSet rs2=pstmt2.executeQuery();
									while(rs2.next())
									{
										System.out.println("Test22");
									%>
									<option value="<%=rs2.getString("opc_name") %>"><%=rs2.getString("opc_name") %></option>
									<%} %>
									</select>
									</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Code</label>
									<div class="col-sm-8">
									<%
									Calendar cal = Calendar.getInstance();
									String year=Integer.toString(cal.get(Calendar.YEAR));
										String year2="100"+year+count;
									%>
										<input type="text" value="<%=year2%>" name="code" class="form-control" id="inputPassword" placeholder="" disabled="disabled">
										<input type="hidden" value="<%=year2%>" name="code" class="form-control1" id="inputPassword" placeholder="">
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Payment Method</label>
									...
									<div class="col-md-6">
										...
										<div class="col-sm-8">
											<button style="float:right;" class="btn-primary btn">Add New Advisor</button>
										</div>
									</div>
								</div>
							</form>
