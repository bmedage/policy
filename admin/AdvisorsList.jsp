...
<!--heder end here-->
	<ol class="breadcrumb">
	 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Company Report<i class="fa fa-angle-right"></i>Company Team List</li>
                
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1" style = "height:320px;">
  	      <center> <h3>Company Team List<button id='btnExport' style="float: right; margin-bottom: 10px;"
							...
							<form class="form-horizontal" action="" method="post">
								<div class="form-group">
									...
									<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Year</label>
										<div class="col-sm-8">
											<select class="form-control1" id="year" placeholder="DD/MM/YYYY" onchange="showState(this.value)">
										<option>select</option>
										<%
										Connection con=DBConnection.getConnection();
										PreparedStatement pstmt11=con.prepareStatement("select * from advisors group by year");
										ResultSet rs11=pstmt11.executeQuery();
										while(rs11.next())
										{
										%>
										<option><%=rs11.getString("year") %></option>
										<%} %>
										</select>
										</div>
									</div>
									...
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">OPC Name </label>
									...
									PreparedStatement pstmt1=conn1.prepareStatement("select * from advisors group by near_opc");
									ResultSet rs1=pstmt1.executeQuery();
									while(rs1.next())
									{
									%>
									<option value="<%=rs1.getString("near_opc") %>"><%=rs1.getString("near_opc") %></option>
									<% }%> --%>
								</select>
								</div>
								</div>
								...
								<div class="col-md-6">
									...
									<div class="col-sm-8">
										<button style="margin-left:420px;" class="btn-primary btn">Done</button>									</div>
									</div>
								</div>
							</form>
						</div>
...
var url="AdvisorsListAddOpcName.jsp";
url +="?year=" +str;
...
function advisorByYear()
{
	var xmlhttp;
	var year=document.getElementById("year").value;
	
	var urls="AdvisorsListByYear.jsp?year="+year;
...
function showState1(str,opcName){
	if (typeof XMLHttpRequest != "undefined"){
	xmlHttp= new XMLHttpRequest();
	}
	else if (window.ActiveXObject){
	...
	var url="AdvisorsListAddAdvCode.jsp";
	url +="?year=" +str+"&opcName="+opcName;
...
function opcnamecall()
{
	...
	var year=document.getElementById("year").value;
	var urls="OPCNameSelect.jsp?opcname="+opcname+"&year="+year;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
...
function advcodecall()
{
	...
	var opcname=document.getElementById("opcnameid").value;
	var year=document.getElementById("year").value;
	var urls="advcode.jsp?advcode="+advcode+"&opcName="+opcname+"&year="+year;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
...
function datechangecall()
{
	...
	var urls="advdatefromto.jsp?advdateto="+advdateto+"&advdatefrom="+advdatefrom+"&opcName="+opcname+"&year="+year;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
