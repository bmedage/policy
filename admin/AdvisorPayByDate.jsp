 				...
 				for(int j=i;j<end.length;j++)
 				{
 				    ...
 				    <tbody>
 				      <tr>
 				        <td><%=j+1%></td>
 				        <%
 				        float bussiness=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearBIdDate(year, start[j], end[j],"bussiness",pinNo,dateFrom,dateTo);
 				       float pbussiness=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearPIdDate(year, start[j], end[j],"bussiness",pinNo,dateFrom,dateTo);
 				      float credit=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearCIdDate(year, start[j], end[j],"bussiness",pinNo,dateFrom,dateTo);
 				     float TDS=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearTIdDate(year, start[j], end[j],"bussiness",pinNo,dateFrom,dateTo);
 				    float admin=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearAIdDate(year, start[j], end[j],"bussiness",pinNo,dateFrom,dateTo);
 				   float debit=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearDIdDate(year, start[j], end[j],"bussiness",pinNo,dateFrom,dateTo);
 				  float withdraw=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearWIdDate(year, start[j], end[j],"bussiness",pinNo,dateFrom,dateTo);
 				 float balance=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearBalIdDate(year, start[j], end[j],"bussiness",pinNo,dateFrom,dateTo);
