...
<%
		try
			...
			ptmt.executeQuery();
		 	...
		 	System.out.println("select * from add_new_policy where Form_no="+appNo);
...
%>
								<div class="form-group">
									...
									<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Date Of Policy</label>
										<div class="col-sm-6">
											<input type="text" class="form-control1" value = "<%= rs.getString("date") %>" name="dop" id="dop" placeholder="Application No" disabled="disabled" disabled="disabled">
										</div>
										<div class="col-sm-2">
								...
								<div class="form-group">
									...
									<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">PAN Card</label>
										<div class="col-sm-6">
											<input type="text" class="form-control1" id="applicationNo" value = "<%= rs.getString("Pan_Card") %>" placeholder="Application No" name="pan_card" disabled="disabled">
										</div>
										<div class="col-sm-2">
									...
									<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Aadhar No</label>
										<div class="col-sm-6">
											<input type="text" class="form-control1" id="custId" value = "<%= rs.getString("Aadhar_No") %>" placeholder="Card No" name="aadhar_no" disabled="disabled">
										</div>
										<div class="col-sm-2">
							...
							<%} %>
							<%
							ResultSet rs2 = st.executeQuery("select COUNT('cust_id') from renewal_master1 where cust_id="+appNo);
							...
							<%
							int cnt = 0;
							ResultSet rs3 = st.executeQuery("select Reciept_no from renewal_master1 where cust_id="+appNo);
							//								 select * from renewal_master1 where cust_id="+custId;
							while(rs3.next())
							{
							...
							<% 
								...
								<%
									...
									ResultSet rs4 = st2.executeQuery("select * from add_new_policy where Form_no="+appNo);
