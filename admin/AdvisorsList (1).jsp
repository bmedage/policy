...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Advisor List</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1">
  	      <center> <h3>Advisor List</h3></center>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post">
								<div class="form-group">
								<div class="col-md-5">
								<label for="inputPassword" class="col-sm-2 control-label">OPC Name </label>
									<div class="col-sm-10">
									<select class="form-control1" id="opcnameid" placeholder="DD/MM/YYYY" name="opcname" onChange="opcnamecall()">
									<%
									Connection conn1=DBConnection.getConnection();
										PreparedStatement ptmt=conn1.prepareStatement("set global max_connections=100000000");
										ptmt.executeQuery();
									PreparedStatement pstmt1=conn1.prepareStatement("select * from opc_master");
								...
								<label for="inputPassword" class="col-sm-2 control-label">Adv Code</label>
									<div class="col-sm-10">
										<select class="form-control1" id="advcodeid" placeholder="DD/MM/YYYY" name="advcode" onChange="advcodecall()">
										<%
									Connection conn2=DBConnection.getConnection();
										
									PreparedStatement pstmt2=conn2.prepareStatement("select * from advisors");
									ResultSet rs2=pstmt2.executeQuery();
									while(rs2.next())
									{
									%>
									<option value="<%=rs2.getInt("pin_no") %>"><%=rs2.getInt("pin_no") %></option>
									<% }%>
										<option></option>
										</select> 
									</div>
								...
								<label for="inputPassword" class="col-sm-2 control-label">Date From  </label>
									<div class="col-sm-10">
										<input type="date" class="form-control1" id="advdatefromid" placeholder=""  name="advdatefrom">
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-2 control-label">Date To </label>
									<div class="col-sm-10">
										<input type="date" class="form-control1" id="advdatefromtoid" placeholder="" onChange="datechangecall()" name="advdateto">
									</div>
								</div>
								</div>
...
<!-- ONCHANGE EVENT -->
<script>
function opcnamecall()
{
	var xmlhttp;
	var opcname=document.getElementById("opcnameid").value;
	alert("OPC Name "+opcname);
	var urls="OPCNameSelect.jsp?opcname="+opcname;
...
function advcodecall()
{
	var xmlhttp;
	var advcode=document.getElementById("advcodeid").value;
	alert("Adv Code "+advcode);
	var urls="advcode.jsp?advcode="+advcode;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
...
function datechangecall()
{
	...
	alert("Date From To to "+advdatefrom +" "+advdateto);
	var urls="advdatefromto.jsp?advdateto="+advdateto+"&advdatefrom="+advdatefrom;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
