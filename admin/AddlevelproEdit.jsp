...
<!--heder end here-->
  ...
  <div class="grid-form1">
  	      <center> <h3>Edit Level & Promotion</h3></center>
  	         <div class="tab-content">
  	          ...
  	          <%
								...
								String query = "SELECT * FROM level where level=?";
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AddlevlandproUpdate.jsp" method="post">
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-5 control-label" style = "font-size:18px;text-align:left;">Financial year </label>
									<div class="col-sm-7">
										
								<input type="Text" value="<%=rs.getString("finyerar") %>" class="form-control1" id="inputPassword" placeholder="" name="finyear" disabled="disabled">	
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;">Level</label>
									...
									<input type="Text" value="<%=rs.getString("level") %>" class="form-control1" id="inputPassword" placeholder="" name="level" disabled="disabled">
									</div>
								</div>
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" style = "font-size:18px;text-align:left;" class="col-sm-5 control-label">Promotive Business </label>
									<div class="col-sm-7">
								...
								<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;"></label>
									...
									<button style="float:right" class="btn-primary btn">Update Level</button>
									</div>
								</div>
									</div>
 	...
 	<font color="blue"><center><h3>Plan Summary</h3></center></font>
 	<% 
 	try
 	{
