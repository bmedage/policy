...
<table  style="border: 3px solid #ddd;" id="table" >
 ...
 ptmt.executeQuery();
    String datefrom=request.getParameter("advdatefrom");
    String dateto=request.getParameter("advdateto");
    String year=request.getParameter("year");
    String opcName=request.getParameter("opcName");
    System.out.println("Date From"+datefrom);
    System.out.println("Date To"+dateto);
    PreparedStatement pstmt=cn.prepareStatement("select * from advisors where doj >? AND doj< ? And year=?");
