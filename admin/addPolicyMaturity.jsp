...
<html>
<head>
<title>Add Policy Maturity</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Add Edit</a><i class="fa fa-angle-right"></i>Add Policy Maturity</li>
  ...
  <div class="grid-form1">
  	      <center> <h3>Add Policy Maturity</h3></center>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="addPolicyMaturitySave.jsp" method="post">
								<div class="form-group">
									<div class="col-md-6">
									<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Application No.</label>
										<div class="col-sm-8">
											<input type="text" name="appNo" id="appNo" class="form-control1" id="applicationNo" placeholder="Application No" name="applicationNo" onchange="displayRec()">
										</div>
									...
									<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Cust ID</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="custId" id="custId" placeholder="Card No" onchange="displayRec1()">
										</div>
...
<script type="text/javascript">
										function displayRec()
										{
											...
											var urls="addPolicyMaturityDipCon.jsp?appNo="+appNo;
											//var urls="addPolicyMaturityDipCon.jsp?appNo="+appNo;
										...
										function displayRec1()
										{
											...
											var urls="addPolicyMaturityDipConByCustId.jsp?custId="+custId;
											//var urls="addPolicyMaturityDipCon.jsp?appNo="+appNo;
											if (window.XMLHttpRequest){
											  xmlhttp=new XMLHttpRequest();
											  }
