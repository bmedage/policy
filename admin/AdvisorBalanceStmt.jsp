...
<html>
<head>
<title>Advisor Balance Statement</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
	 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Advisor Report<i class="fa fa-angle-right"></i>Advisor Balance Statement</li>
  ...
  <div class="grid-form1">
  	      <center> <h3>Advisor Balance Statement<button id='btnExport' style="float: right; margin-bottom: 10px;"
    ...
    <script type="text/javascript" src="http://sheetjs.com/demos/Export2Excel.js"></script>
  	         ...
  	         <div class="tab-content">
							...
							<form class="form-horizontal" action="" method="post">
								...
								<label for="inputPassword" class="col-sm-3 control-label"><b>Year</b></label>
									<div class="col-sm-8">
										...
										ptmt.executeQuery();
										PreparedStatement pstmt11=con.prepareStatement("select * from wallet group by year");
					 ...
					 <script type="text/javascript">
				      ...
				      var url="AdvisorBalanceStmtAddAdvCode.jsp";
				      url +="?year=" +str;
				      ...
				      gettableByYear();
										...
										function getACStmtByADVCOde()
										{
											...
											var urls="AdvisorBalanceStmtDispTbByAdvCode.jsp?advCode="+advCode+"&year="+year;
					 ...
					 function dispTbByTransType()
						{
						 ...
						 function gettableByYear()
						{
							var xmlhttp;
							
							var year=document.getElementById("year").value;
							
							var urls="AdvisorBalanceStmtDispTbByYear.jsp?year="+year;
							if (window.XMLHttpRequest){
							  xmlhttp=new XMLHttpRequest();
							  }
							else{
