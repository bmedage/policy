...
<html>
<head>
<title>Add Level and Promotion </title>
...
<!--heder end here-->
	<ol class="breadcrumb">
	 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Plan Master</a><i class="fa fa-angle-right"></i>Add Level & Promotion</li>
                
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1">
  	      <center> <h3>Add Level & Promotion</h3></center>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AddLevelandPromotionSave.jsp" method="post">
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Financial year </label>
									<div class="col-sm-8">
									<select id="fyear" name="finyear" class="form-control">
									...
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-5 control-label" style = "font-size:18px;text-align:left;">Level</label>
									<div class="col-sm-7">
										<input type="Text" name="level" class="form-control1" id="inputPassword" placeholder="Enter level" required>
									</div>
								</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Short Level NM</label>
									<div class="col-sm-8">
										<input type="Text" name="slevel" class="form-control1" id="inputPassword" placeholder="Enter Level Short Name" required>
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-3 control-label"></label>
									<div class="col-sm-8">
										<button style="margin-left:252px;" class="btn-primary btn">Add Level</button>
									</div>
								</div>	
								</div>
 	...
 	<font color="blue"><center><h3>Level Summary<button id='btnExport' style="float: right; margin-bottom: 10px;"
 ...
 <script type="text/javascript" src="http://oss.sheetjs.com/js-xlsx/xlsx.core.min.js" ></script>
    ...
    <tbody>
      <tr>
        ...
        <td><%=rs.getString("shortName")%></td>
        <td><%=rs.getString("pbuss")%></td>
        
        <td><a href="AddlevelproEdit.jsp?level=<%=rs.getString("level")%>">Edit</a></td>
      </tr>
      <%
	} %>
    </tbody>
