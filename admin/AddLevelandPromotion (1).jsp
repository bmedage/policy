						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AddLevelandPromotionSave.jsp" method="post">
								...
								<label for="inputPassword" class="col-sm-2 control-label">Financial year </label>
									<div class="col-sm-8">
										<input type="Text" name="finyear" class="form-control1" id="inputPassword" placeholder="2018">
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-2 control-label">Level</label>
									<div class="col-sm-8">
										<input type="Text" name="level" class="form-control1" id="inputPassword" placeholder="Enter level">
									</div>
								</div>
								</div>
								<div class="form-group">
								...
								<label for="inputPassword" class="col-sm-2 control-label">Promotive Business </label>
									<div class="col-sm-8">
										<input type="Text" name="pbuss" class="form-control1" id="inputPassword" placeholder="">
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="col-sm-10">
											<button style="margin-left:100px" class="btn-primary btn">Add Level</button>
									</div>
								</div>
