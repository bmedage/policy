...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Plan Master</a><i class="fa fa-angle-right"></i>Add Plan ID</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="col-md-10">
  <center><h3 style=" margin-left: 5%;"><b>Add Plan ID</b></h3></center>
  </div>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AddPlanNameSave.jsp" method="post">
								<div class="form-group" >
									...
									<div class="col-md-6">
									<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;">Type</label>
										<div class="col-sm-8">
								...
								<div class="form-group" >
									...
									<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Plan Id</label>
										<div class="col-sm-8">
											<input type="Text" class="form-control1" id="name" placeholder="Enter Plan Name" name="planid" required>
										</div>
									</div>
									<div class="col-md-6">
									<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;">Amount</label>
										<div class="col-sm-8">
											<input type="Text" class="form-control1" id="amount" placeholder="Enter Amount" name="amount" required>
										</div>
									</div>
								</div>
								<div class="form-group" >
									...
									<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;"></label>
										<div class="col-sm-8">
											<button style="float:right;" class="btn-primary btn">Add Plan</button>	
										</div>
									</div>
								</div>
 	...
 	<font color="blue"><center><h3>Plan Summary<button id='btnExport' style="float: right; margin-bottom: 10px;"
 ...
 <script type="text/javascript" src="http://oss.sheetjs.com/js-xlsx/xlsx.core.min.js" ></script>
    ...
    <script type="text/javascript" src="http://sheetjs.com/demos/Export2Excel.js"></script>
 	...
 	String select="select * from addplan";
    ...
    <thead>
      <tr>
        ...
        <th><center><b>Plan Type</b></center></th>
        <th><center><b>Plan Id</b></center></th>
         <th><center><b>Amount</b></center></th>
        <th><center><b>Edit</b></center></th>
        <th><center><b>Act/Dct</b></center></th>
      </tr>
    </thead>
    <%
    int count=0;
    ...
    <tbody>
      <tr>
        ...
        <td><center><%=rs.getString("year")%></center></td>
        <td><center><%=rs.getString("type")%></center></td>
         <td><center><%=rs.getString("planid")%></center></td>
         <td><center><%=rs.getString("amount")%></center></td>
          <td><center><a class="forprint" href="AddplanidEdit.jsp?planid=<%=rs.getString("planid")%>&type=<%=rs.getString("type")%>&year=<%=rs.getString("year")%>"><i class="fa fa-pencil forprint" ></i></a></center></td>
          <td><center><a class="forprint" href="AddEditOPAListEdit.jsp?level=">Act /</a><a class="forprint" href="AddEditOPAListEdit.jsp?level=">Dct</a></center></td>
      </tr>
      <%
	} %>
	<tr>
