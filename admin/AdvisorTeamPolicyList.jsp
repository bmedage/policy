...
<html>
<head>
<title>OPC Team Policy List</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Advisor Report<i class="fa fa-angle-right"></i>Advisor Team Policy List</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1">
  	      <center> <h3>Advisor Team Policy List<button id='btnExport' style="float: right; margin-bottom: 10px;"
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post">
								...
								<label for="inputPassword" class="col-sm-2 control-label">Fin Year</label>
									<div class="col-sm-10">
										<select class="form-control1" id="year" placeholder="DD/MM/YYYY" name="year" onChange="showState(this.value)">
								...
								<label for="inputPassword" class="col-sm-2 control-label">Adv Code  </label>
									<div class="col-sm-10" id="state">
										<select class="form-control1" id="introCode" placeholder="DD/MM/YYYY" name="introCode" onChange="introCodecall1()">
										<option>-select-</option>
										<option>
									<%-- <%
								 ...
								 var xmlHttp  
							      ...
							      var url="AdvisorTeamPolicyListAddAdvCode.jsp";
							      url +="?year=" +str;
							      ...
							      showState1(year);
									 ...
									 var xmlHttp  
								      ...
								      var url="AdvisorTeamPolicyListAddCustId.jsp";
								      url +="?year=" +str;
...
function introCodecall()
{
	...
	var urls="AdvisorTeamPolicyListByIntC.jsp?introCode="+introCode+"&year="+year;
...
function pcustidcall()
{
	...
	var urls="AdvisorTeamPolicyListByCustId.jsp?ppcustid="+ppcustid+"&year="+year;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
