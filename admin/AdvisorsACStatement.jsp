...
<html>
<head>
<title>Company A/C Statement</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
	 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Company Report<i class="fa fa-angle-right"></i>Company TA/C Statement</li>
  ...
  <div class="grid-form1">
  	      <center> <h3>Company A/C Statement<button id='btnExport' style="float: right; margin-bottom: 10px;"
								class="btn btn-primary forprint"  onclick="download();">
								<i class="fa  fa-file-excel-o"></i>
							</button>
							<button style="float: right; margin-bottom: 10px;"
								class="btn btn-success forprint" onclick="printDiv('addpin')">
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post">
								...
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label"><b>Year</b></label>
									<div class="col-sm-8">
								...
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label"><b>Adv Code</b> </label>
									<div class="col-sm-8" id="state">
										<select class="form-control1" id="advCode" placeholder="DD/MM/YYYY" onchange="getACStmtByADVCOde()">
										<option>select</option>
										<%-- <%
										PreparedStatement pstmt=con.prepareStatement("select * from advisors");
										ResultSet rs=pstmt.executeQuery();
										while(rs.next())
										{
										%>
										<option><%=rs.getString("pin_no") %></option>
										<%} %> --%>
										</select>
									</div>	
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label"><b>Trans. Type</b></label>
									<div class="col-sm-8">
										<select class="form-control1" id="transType" id="inputPassword" placeholder="DD/MM/YYYY" onchange="dispTbByTransType()">
										<option>--select--</option>
										<option>All</option>
									...
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label"><b>Date To </b></label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" id="dateTo" placeholder="" onchange="getTableByDate()">
									</div>
								</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label"><b></b></label>
									<div class="col-sm-8">
					 ...
					 <script type="text/javascript">
				      ...
				      var url="AdvisorsACStatementGerId.jsp";
				      url +="?year=" +str;
				      ...
				      document.getElementById("state").innerHTML=xmlHttp.responseText   
										...
										function getACStmtByADVCOde()
										{
											var xmlhttp;
											var advCode=document.getElementById("advCode").value;
											var year=document.getElementById("year").value;
											var urls="AdvisorsACStatementByAdvCode.jsp?advCode="+advCode+"&year="+year;
					 ...
					 function dispTbByTransType()
						{
							var xmlhttp;
							var transType=document.getElementById("transType").value;
							var advCode=document.getElementById("advCode").value;
							var year=document.getElementById("year").value;
							var urls="AdvisorsACStatementByTransType.jsp?advCode="+advCode+"&transType="+transType+"&year="+year;
							if (window.XMLHttpRequest){
							  xmlhttp=new XMLHttpRequest();
							  }
							else{
						 ...
						 function getTableByDate()
						{
							...
							var urls="AdvisorsACStatementByDate.jsp?advCode="+advCode+"&transType="+transType+"&year="+year+"&dateTo="+dateTo;
							if (window.XMLHttpRequest){
							  xmlhttp=new XMLHttpRequest();
							  }
							else{
					 ...
					 <div id="addpin" style = "width:95%;margin:0 auto;">
