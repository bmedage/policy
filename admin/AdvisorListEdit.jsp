...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i> Advisor Master<i class="fa fa-angle-right"></i>Edit Advisor</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="grid-form1">
  	      <center> <h3>Edit Advisors</h3></center>
  	         ...
  	         <%
								...
								String query = "SELECT * FROM advisors where pin_no=? And year=?";
								PreparedStatement pstmt=con.prepareStatement(query);
								pstmt.setString(1, request.getParameter("pin_no"));
								pstmt.setString(2, request.getParameter("year"));
								ResultSet rs=pstmt.executeQuery();			
								//Extact result from ResultSet rs
								int count=0;
								System.out.println("pin_no"+request.getParameter("pin_no"));
							while(rs.next()){
									count=rs.getInt("pin_no");
									
								   // System.out.println("pin_no="+rs.getInt("pin_no"));				
						...
						<div class="tab-pane active" id="horizontal-form">
								...
								<form class="form-horizontal" action="AdvisorListUpdate.jsp" method="post">
								<div class="form-group">
								
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Pin No</label>
									<div class="col-sm-8">
										<input type="hidden" value="<%=rs.getString("pin_no") %>" name = "pin_no">								
										<input type="hidden" value="<%=rs.getString("year") %>" name = "year">
									<input type="Text" value="<%=rs.getString("pin_no") %>" class="form-control1" id="inputPassword" placeholder="" disabled="disabled">
									</div>	
								...
								<label for="inputPassword" class="col-sm-2 control-label">Name</label>
									...
									<input type="Text" value="<%=rs.getString("name") %>" class="form-control1" id="inputPassword" placeholder="" name="name">
									</div>
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Intoducer Code</label>
									<div class="col-sm-8">
										
									<input type="text" value="<%=rs.getString("intro_code") %>" class="form-control1" id="inputPassword" name="intCode">
									</div>
								</div>
									<script type="text/javascript">
									function s()
									{
										 	...
										 	var urls="getIntoName.jsp?introId="+introCode;    
									...
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Intro name</label>
									<div class="col-sm-8">
										
									<input type="text" value="<%=rs.getString("intro_name") %>" class="form-control1" id="inputPassword" name="itroName">
									</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Pan card</label>
									<div class="col-sm-8">
										
										<input type="text" value="<%=rs.getString("pan_card") %>" class="form-control1" id="inputPassword" name="panCard">
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Mobile Number</label>
									<div class="col-sm-8">
										
										<input type="text" value="<%=rs.getString("mobile") %>" class="form-control1" id="inputPassword" name="mobNo">
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Aadhar no</label>
									<div class="col-sm-8">
										
										<input type="text" value="<%=rs.getString("addhar_card") %>" class="form-control1" id="inputPassword" name="aadharNo">
									</div>
								</div>
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Near OPC</label>
									<div class="col-sm-8">
									<select class="form-control" name="nearOpc" id="nearOpc" onchange="sel1()">
									<option value="<%=rs.getString("near_opc") %>"><%=rs.getString("near_opc") %>
									<%
									System.out.println(session.getAttribute("email"));
									Connection cn=DBConnection.getConnection();
									PreparedStatement pstmt1=cn.prepareStatement("select * from opc_master");
								...
								<script>
									function sel1()
									{
										var nearOpc=document.getElementById("nearOpc").value;
										var urls="getPinByOpcInAdvicer.jsp?opcName="+nearOpc;    
									 	if (window.XMLHttpRequest){
									 		  xmlhttp=new XMLHttpRequest();
									 		  }
									 		else{
									 		...
									 		xmlhttp.onreadystatechange=function(){
									 		  if (xmlhttp.readyState==4){
									 		        var pinno=xmlhttp.responseText;
									 		       document.getElementById("pinno").value = pinno;
									 		      document.getElementById("pinno1").value = pinno;
									 		    }
									 		};
									 		xmlhttp.open("GET",urls,true);	
									 		xmlhttp.send();
								...
								<label for="inputPassword" class="col-sm-2 control-label">Date Of Birth</label>
									...
									<input type="text" value="<%=rs.getString("dob") %>" class="form-control1" id="inputPassword" name="dob">
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-2 control-label">Address</label>
									<div class="col-sm-8">
										...
										<input type="text" value="<%=rs.getString("address") %>" class="form-control1" id="inputPassword" name="address">
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-2 control-label">Code</label>
									<div class="col-sm-8">
										...
										<input type="text" value="<%=rs.getString("code") %>" class="form-control1" id="inputPassword" name="code">
									</div>
								</div>
								...
								<label for="inputPassword" class="col-sm-2 control-label">Pin code</label>
									<div class="col-sm-8">
										...
										<input type="text" value="<%=rs.getString("pin_code") %>" class="form-control1" id="inputPassword" name="pinCode">
									</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Payment Method</label>
									<div class="col-sm-8">
									<select  class="form-control1" value="<% rs.getString("pay_method"); %>" id="inputPassword" name="paymethod">
							<option value="<%= rs.getString("pay_method") %>"><%= rs.getString("pay_method")%></option>
									
									
									<option>Cash</option>
									<option>Cash Voucher</option>
									<option>Net Banking</option>
									<option>Debit Crad</option>
								...
								<div class="form-group">
			<div class="col-md-12">
			<button style="float: right;" class="btn-primary btn">Update</button>
			</div>
