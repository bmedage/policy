...
<!--heder end here-->
	<ol class="breadcrumb">
	 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Plan Master</a><i class="fa fa-angle-right"></i>Add OPA List</li>
              
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1">
  	      <center> <h3>Add OPA List<button id='btnExport' style="float: right; margin-bottom: 10px;"
								class="btn btn-primary forprint"  onclick="download();">
								<i class="fa  fa-file-excel-o"></i>
							</button>
							<button style="float: right; margin-bottom: 10px;"
								class="btn btn-success forprint" onclick="printDiv('printTb')">
 ...
 <script type="text/javascript" src="http://oss.sheetjs.com/js-xlsx/xlsx.core.min.js" ></script>
    ...
    <script type="text/javascript" src="http://sheetjs.com/demos/Export2Excel.js"></script>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AddEditOPAListSave.jsp" method="post">
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-5 control-label" style = "font-size:18px;text-align:left;">Financial year </label>
									<div class="col-sm-7">
									<select id="fyear" name="finyear" class="form-control" disabled="disabled">
									...
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;">Level</label>
									<div class="col-sm-8">
										<select class="form-control" id="inputPassword" name="level">
										<%
								...
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-5 control-label" style = "font-size:18px;text-align:left;">Promotive Business </label>
									<div class="col-sm-7">
										<input type="Text" name="pbuss" class="form-control1" id="inputPassword" placeholder="" required>
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;">Prize</label>
									<div class="col-sm-8">
										<input type="text" name="prize" class="form-control1" id="inputPassword" placeholder="" required>
									</div>
								</div>
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-5 control-label" style = "font-size:18px;text-align:left;">Prize Amount </label>
									<div class="col-sm-7">
										<input type="Text" name="pAmount" class="form-control1" id="inputPassword" placeholder="" required>
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;">Period</label>
									<div class="col-sm-8">
										<input type="text" name="period" class="form-control1" id="inputPassword" placeholder="" required>
									</div>
								</div>
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-5 control-label" style = "font-size:18px;text-align:left;">Image</label>
									<div class="col-sm-7">
										<input type="file" name="image" class="form-control1" id="inputPassword" placeholder="">
									</div>
								</div>
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-3 control-label" style = "font-size:18px;text-align:left;"></label>
									<div class="col-sm-8">
										<button style="float:right;" class="btn-primary btn">Add OPA Prize</button>
									</div>
								</div>	
 	...
 	try
 	{
 	Connection cn1=DBConnection.getConnection();
 	String select="select * from opa";
 	PreparedStatement pstmt=cn1.prepareStatement("select * from opa");
    ...
    <tbody>
      <tr>
        <td><%=counter%></td>
		<td><%=rs.getString("finyerar")%></td>
        <td><%=rs.getString("level")%></td>
        <td><%=rs.getString("pbuss")%></td>
        <td><%=rs.getString("price")%></td>
        <td><%=rs.getString("pamount")%></td>
          <td><%=rs.getString("period")%></td>
          
          <td><center><a class="forprint" href="AddEditOPAListEdit.jsp?level=<%=rs.getString("level")%>"><i class="fa fa-pencil forprint" ></i></a></center></td>
      </tr>
      <%
	} %>
    </tbody>
