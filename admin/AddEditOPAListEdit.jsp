...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Our OPA</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1">
  	      <center> <h3> Edit OPA </h3></center>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
						<%
						Connection con=DBConnection.getConnection();
						PreparedStatement pstmt=con.prepareStatement("select * from opa where level=? group by level");
						pstmt.setString(1, request.getParameter("level"));
						ResultSet rs=pstmt.executeQuery();
						while(rs.next())
						{
						%>
							<form class="form-horizontal" action="AddEditOPAListUpdate.jsp" method="post">
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Financial year </label>
									<div class="col-sm-8">
										<input type="Text" value="<%=rs.getString("finyerar") %>" name="finyear" class="form-control1" id="inputPassword" placeholder="2018" disabled="disabled">
										<input type="hidden" value="<%=rs.getString("finyerar") %>" name="finyear" class="form-control1" id="inputPassword" placeholder="2018">
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Level</label>
									<div class="col-sm-8">
										<select class="form-control" id="inputPassword" name="level" disabled="disabled">
										<option value="<%=rs.getString("level") %>"><%=rs.getString("level") %></option>
										<%
								...
								<input type="hidden" value="<%=rs.getString("level") %>" class="form-control1" id="inputPassword" name="level">
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Promotive Business </label>
									<div class="col-sm-8">
										<input type="Text" value="<%=rs.getString("pbuss") %>" name="pbuss" class="form-control1" id="inputPassword" placeholder="">
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Prize</label>
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("price") %>" name="prize" class="form-control1" id="inputPassword" placeholder="">
									</div>
								</div>
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Prize Amount </label>
									<div class="col-sm-8">
										<input type="Text" name="pAmount" value="<%=rs.getString("pamount") %>" class="form-control1" id="inputPassword" placeholder="">
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Period</label>
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("period") %>" name="period" class="form-control1" id="inputPassword" placeholder="">
									</div>
								</div>
								</div>
