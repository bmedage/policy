...
<table border = "1" id="table" style = "width : 100%;margin:0 auto;">
	 					...
	 					<tr style = "height:40px;">
	  						...
	  						<th><center><b><%
	  						int name5 = 0;
	  						PreparedStatement pstmt5=con.prepareStatement("SELECT SUM(debit) FROM transaction where pinNo=? And tranType=? And year=? And date<?");
	  						pstmt5.setString(1, request.getParameter("advCode"));
	  						pstmt5.setString(2, request.getParameter("transType"));
	  						pstmt5.setString(3, request.getParameter("year"));
	  						pstmt5.setString(4, request.getParameter("dateTo"));
						...
						<%=name5 %>	
	  						...
	  						<%
	  						int name6 = 0;
	  						PreparedStatement pstmt6=con.prepareStatement("SELECT SUM(credit) FROM transaction where pinNo=? And tranType=? And year=? And date<?");
	  						pstmt6.setString(1, request.getParameter("advCode"));
	  						pstmt6.setString(2, request.getParameter("transType"));
	  						pstmt6.setString(3, request.getParameter("year"));
	  						pstmt6.setString(4, request.getParameter("dateTo"));
						...
						<%=name6 %>
	  						<th><center><b><%
	  						int name = 0;
	  						PreparedStatement pstmt1=con.prepareStatement("SELECT SUM(debit) FROM transaction where pinNo=? And tranType=? And year=? And date<?");
	  						pstmt1.setString(1, request.getParameter("advCode"));
	  						pstmt1.setString(2, request.getParameter("transType"));
	  						pstmt1.setString(3, request.getParameter("year"));
	  						pstmt1.setString(4, request.getParameter("dateTo"));
						...
						<%=name %>	
	  						...
	  						<%
	  						int name1 = 0;
	  						PreparedStatement pstmt2=con.prepareStatement("SELECT SUM(credit) FROM transaction where pinNo=? And tranType=? And year=? And date<?");
	  						pstmt2.setString(1, request.getParameter("advCode"));
	  						pstmt2.setString(2, request.getParameter("transType"));
	  						pstmt2.setString(3, request.getParameter("year"));
	  						pstmt2.setString(4, request.getParameter("dateTo"));
						...
						<%=name1 %>	
	  						...
	  						<%
	  						int name2 = 0;
	  						PreparedStatement pstmt3=con.prepareStatement("SELECT SUM(credit) FROM transaction where pinNo=? And tranType=? And year=? And date<?");
	  						pstmt3.setString(1, request.getParameter("advCode"));
	  						pstmt3.setString(2, request.getParameter("transType"));
	  						pstmt3.setString(3, request.getParameter("year"));
	  						pstmt3.setString(4, request.getParameter("dateTo"));
						...
						<%=name2 %>	
	 					...
	 					PreparedStatement pstm=con.prepareStatement("select * from transaction where pinNo=? And tranType=? And date >? AND date< ?");
	 					pstm.setString(1, request.getParameter("advCode"));
	 					pstm.setString(2, request.getParameter("transType"));
	 					pstm.setString(3, request.getParameter("dateFrom"));
	 					pstm.setString(4, request.getParameter("dateTo"));
