...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Our Plan</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="col-md-10">
  <center><h3 style=" margin-left: 5%;"><b>Edit Plan</b></h3></center>
  </div>
 	...
 	String select="";
 	PreparedStatement pstmt=cn.prepareStatement("select * from add_plan where plan_id=?");
	...
	%>		
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="Addplanupdate.jsp" method="post">
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Financial year </label>
									<div class="col-sm-8">
										<input type="Text" value="<%=rs.getString("year") %>" class="form-control1" id="inputPassword" placeholder="2018" name="fyear">
										
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Month</label>
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("month") %>"class="form-control1" id="inputPassword" placeholder="" name="pmonth">
									</div>
								</div>
								</div>
								<div class="form-group">
								...
								<label for="inputPassword" class="col-sm-2 control-label">Plan ID </label>
									<div class="col-sm-8">
										<input type="Text" value="<%=rs.getString("plan_id")%>" class="form-control1" id="inputPassword" placeholder="Ex.P102" name="planid">
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Interest</label>
									<div class="col-sm-8">
										<input type="text"  value="<%=rs.getString("interest")%>" class="form-control1" id="inputPassword" placeholder="Interest In Ex 3%" name="interest">
									</div>
								</div>
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Min. Amount </label>
									<div class="col-sm-8">
										<input type="Text" value="<%=rs.getString("min_amt")%>" class="form-control1" id="inputPassword" placeholder="Min Amount EX.5000" name="minamt">
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Pro. Business</label>
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("pro_business")%>" class="form-control1" id="inputPassword" placeholder="Promoting business" name="probusiness">
									</div>
								</div>
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Incentive </label>
									<div class="col-sm-8">
										<input type="Text" value="<%=rs.getString("incentive")%>" class="form-control1" id="inputPassword" placeholder="Incentive" name="incentive">
									</div>
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Remarks</label>
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("remark")%>" class="form-control1" id="inputPassword" placeholder="remarks" name="remark">
									</div>
								</div>
								</div>
								<div class="form-group">
			<div class="col-md-12">
			<button style="margin-left: 77.6%;" class="btn-primary btn">Update</button>
			</div>
		</div>
							</form>
							<%} %>
