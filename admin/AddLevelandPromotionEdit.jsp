...
<html>
<head>
<title>Add Level and Promotion Structure</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Level & Promotion</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1">
  	      <center> <h3>Edit Level & Promotion</h3></center>
  	      
  	   <%
				Connection cn=DBConnection.getConnection();
 	
 	PreparedStatement pstmt=cn.prepareStatement("select * from level where level=?");
	...
	%>		   
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AddLevelandPromotionupdate.jsp" method="post">
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Financial year </label>
									
								<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("finyerar") %>"class="form-control1" id="inputPassword" placeholder="2018" name="finyear1">
									</div>	
									
								</div>
									
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Level</label>
									
									
									<div class="col-sm-8">
									<input type="hidden" name="level" value="<%=rs.getString("level") %>">
										<input type="text" value="<%=rs.getString("level") %>"class="form-control1" id="inputPassword" placeholder="" name="level1" disabled="disabled">
									</div>	
								</div>
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Promotive Business </label>
									
									
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("pbuss") %>"class="form-control1" id="inputPassword" placeholder="" name="pbuss">
									</div>
								...
								<label for="inputPassword" class="col-sm-2 control-label">Incentive % </label>
									...
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("incentive") %>"class="form-control1" id="inputPassword" placeholder="" name="incentive">
									</div>	
								</div>
								</div>
								<div class="form-group">
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Min FO </label>
									
									
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("minFO") %>"class="form-control1" id="inputPassword" placeholder="" name="minFO">
									</div>
									...
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label">Max FO</label>
									
									<div class="col-sm-8">
										<input type="text" value="<%=rs.getString("maxFO") %>"class="form-control1" id="inputPassword" placeholder="" name="maxFO">
									</div>
								</div>
								</div>
								<div class="form-group">
