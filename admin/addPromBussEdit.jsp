...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Add plan<i class="fa fa-angle-right"></i>Promotional Bussiness Edits</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="col-md-10">
  <center><h3 style=" margin-left: 5%;"><b>Promotional Bussiness Edits</b></h3></center>
  </div>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" style = "margin-left:250px;" id="horizontal-form">
						<form class="form-horizontal" action="addPromBussUpdate.jsp" method="post">
						<%
						Connection con=DBConnection.getConnection();
						PreparedStatement pstmt1=con.prepareStatement("select * from prom_buss_structure where type=? And year=?");
						...
						<input  type="hidden" id="fyear" value="<%=rs1.getString("year")%>" name="fyear" class="form-control">
								...
								<label for="inputPassword" class="col-sm-2 control-label">Financial year </label>
									...
									<div class="col-sm-6">
									<input type="text" class="form-control" value="<%=rs1.getString("type")%>" id="type" name="type" disabled="disabled">
									<input type="hidden" class="form-control1" value="<%=rs1.getString("type")%>" id="type" name="type">
								</div>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
									<input type="Text" class="form-control1" id="fyear" name="mon<%=arr[i] %>" required>
								</div>
									</div>
								<%} %>
								<div class="form-group">
