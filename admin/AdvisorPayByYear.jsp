 				...
 				for(int j=i;j<end.length;j++)
 				{
 				    ...
 				    <tbody>
 				      <tr>
 				        <td><%=j+1%></td>
 				        <%
 				        float bussiness=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearB(year, start[j], end[j],"bussiness");
 				       float pbussiness=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearP(year, start[j], end[j],"bussiness");
 				      float credit=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearC(year, start[j], end[j],"bussiness");
 				     float TDS=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearT(year, start[j], end[j],"bussiness");
 				    float admin=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearA(year, start[j], end[j],"bussiness");
 				   float debit=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearD(year, start[j], end[j],"bussiness");
 				  float withdraw=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearW(year, start[j], end[j],"bussiness");
 				 float balance=GetSumForAdvisorPayIdYear.getSumForAdvisorPayIdYearBal(year, start[j], end[j],"bussiness");
