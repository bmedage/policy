...
<html>
<head>
<title>Add Promotive Business Calculation</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
	 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Plan Master</a><i class="fa fa-angle-right"></i>Add Promotive Business Calculation</li>
                
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1">
  	      <center> <h3>Add Promotive Business Calculation<button id='btnExport' style="float: right; margin-bottom: 10px;"
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
									<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Financial Year</label>
										<div class="col-sm-8">
										<select id="fyear" name="fyear" class="form-control" onchange="dispTb()">
									...
									<option value="2018-19">2018-19</option>
										...
										function dispTb()
										{
											...
											var urls="addPrombussDispTb.jsp?fyear="+year;
...
function popcnamecall()
{
	...
	alert("POPC Name "+popcname);
	var urls="policyOPCName.jsp?popcname="+popcname;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
...
function pcustidcall()
{
	...
	alert("pcustid "+ppcustid);
	var urls="PolicyCustID.jsp?ppcustid="+ppcustid;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
