...
<!--heder end here-->
	<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Advisor Report<i class="fa fa-angle-right"></i>Advisor Team List</li>
              
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1" style = "height:320px;">
  	      <center> <h3>Advisor Team List<button id='btnExport' style="float: right; margin-bottom: 10px;"
...
var url="AdvisorsTeamListAddAdvCode.jsp";
url +="?year=" +str;
...
function advcodecall()
{
	...
	var year=document.getElementById("year").value;
	var urls="AdvisorsTeamListDisptbAdvC.jsp?advcode="+advcode+"&year="+year;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
