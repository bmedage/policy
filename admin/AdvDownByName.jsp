...
<div class = "col-md-12" style = "overflow-x: auto">   
   <table id="table" style=" width:auto">
    ...
    System.out.println(" Adv Code "+name);
    String year=request.getParameter("year");
    System.out.println(" Adv Code "+year);
    String advCode=GetlevelOfAAdvisor.getAdvCodeFromLevel(name,year);
    System.out.println(" Adv Code "+advCode);
    String getlevelOfAAdvisor=GetlevelOfAAdvisor.getlevelOfAAdvisor(advCode,year);
