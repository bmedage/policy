...
<html>
<head>
<title>Advisor  Promotion List</title>
...
<li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Yearly Advisor Report <i class="fa fa-angle-right"></i>Advisor Promotion List</li>
                </i></li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1" style = "height:320px;">
  	      <center> <h3>Advisor Promotion List<button id='btnExport' style="float: right; margin-bottom: 10px;"
...
var url="AdvisorsTeamPromotionListAddAdvCode.jsp";
url +="?year=" +str;
...
function dispTbByOpcName()
{
	...
	var urls="AdvisorsTeamPromotionListDispTbByOPCName.jsp?year="+year+"&opcName="+opcName;
...
function dispTbByAdvCode()
{
	...
	var urls="AdvisorsTeamPromotionListDispTbByAdvCode.jsp?year="+year+"&advCode="+advCode;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
