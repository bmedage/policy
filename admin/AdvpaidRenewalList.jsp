...
<html>
<head>
<title> Advisor Paid Reneweal List</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Paid Reneweal List</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  <div class="grid-form1" style = "height:300px;">
  	      <center> <h3>Paid Reneweal List</h3></center>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post">
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Adv Name </label>
									<div class="col-sm-8">
										<select class="form-control1" id="advName" name="advName" placeholder="" onchange="callByAdvName()">
										<option>--Select--</option>
										<%
										Connection con1=DBConnection.getConnection();
										PreparedStatement pst=con1.prepareStatement("select * from add_new_policy group by intro_name");
										ResultSet r=pst.executeQuery();
										while(r.next())
										{%>
										<option value="<%=r.getString("intro_name")%>"><%=r.getString("intro_name") %></option>
										<%} %>
										</select>
										<script type="text/javascript">
										function callByAdvName()
										{
											var xmlhttp;
											var advName=document.getElementById("advName").value;
											var urls="AdvpaidRenewalListDispTbByAdvName.jsp?advName="+advName;
											...
											xmlhttp.onreadystatechange=function(){
											  if (xmlhttp.readyState==4){
											        ...
											        document.getElementById("dispTb").innerHTML = result;
											    }
											};
								...
								<div class="col-md-6">
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Client ID</label>
									<div class="col-sm-8">
										<select class="form-control1" name="clientId" id="clientId" placeholder="" onchange="callByAdvId()">
										<option>--Select--</option>
										<%
										PreparedStatement pst1=con1.prepareStatement("select * from add_new_policy group by Cust_Id");
										ResultSet r1=pst1.executeQuery();
										while(r1.next())
										{%>
										<option value="<%=r1.getString("Cust_Id")%>"><%=r1.getString("Cust_Id") %></option>
										<%} %>
										</select>
										<script type="text/javascript">
										function callByAdvId()
										{
											...
											var urls="AdvpaidRenewalListDispTbByClientId.jsp?clientId="+clientId;
											if (window.XMLHttpRequest){
											  xmlhttp=new XMLHttpRequest();
											  }
											else{
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Date To </label>
									...
									function callByDate()
									{
										...
										var urls="AdvpaidRenewalListDispTbByDate.jsp?dateFrom="+dateFrom+"&dateTo="+dateTo;
										if (window.XMLHttpRequest){
										  xmlhttp=new XMLHttpRequest();
										  }
										else{
								...
								<div class = "col-md-12">
									<div class="col-md-12">
										<button style="margin-left:950px;" class="btn-primary btn">Done</button>
									</div>
								</div>
							</form>
						</div>
...
function pdatechangecall()
{
	...
	var urls="AdvpaidRenewalListDispTbByDate.jsp?pdateto="+pdateto+"&pdatefrom="+pdatefrom;
	if (window.XMLHttpRequest){
	  xmlhttp=new XMLHttpRequest();
	  }
	else{
