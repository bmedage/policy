...
<!--heder end here-->
	<ol class="breadcrumb">
	 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Plan Master</a><i class="fa fa-angle-right"></i>Add Plan Maturity</li>
  ...
  <div class="col-md-12">
  <center><h3><b>Add Plan Maturity </b></h3></center>
  </div>
  	         ...
  	         <div class="tab-content" style = "margin-left:50px;">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="AddPlanSave.jsp" method="post">
								...
								<label for="inputPassword" class="col-sm-4 control-label" style = "font-size:18px;text-align:left;">Financial year </label>
									...
									<div class="col-md-6">
								<label for="inputPassword" class="col-sm-2 control-label" style = "font-size:18px;text-align:left;">Type</label>
									<div class="col-sm-8">
									<select class="form-control" name="type" id="type" onchange="displayTable()">
									<option>Select</option>
									<%
									Connection con=DBConnection.getConnection();
										PreparedStatement pstmt=con.prepareStatement("select * from addPlan GROUP  BY type");
									...
									function displayTable()
									{
										...
										var urls="AddPlanDispTb.jsp?type="+type+"&fyear="+fyear;
 	...
 	<font color="blue"><center><h3>Plan Summary<button id='btnExport' style="float: right; margin-bottom: 10px;"
							...
							<script type="text/javascript">
							 function download() {
		  	      		        	export_table_to_excel('table', 'xlsx' || 'xlsx'); }
							</script>
							<button style="float: right; margin-bottom: 10px;"
								class="btn btn-success forprint" onclick="printDiv('table')">
